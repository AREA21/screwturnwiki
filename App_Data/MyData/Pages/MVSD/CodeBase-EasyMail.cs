...
== SVN Repository Url==
svn://joshua4/CodeBase/EasyMail/trunk
...
==Connect EasyMail with an EWE==
<pre>
KnowledgeBase: [++KnowledgeBase.Connect-an-EasyWebEditNet-website-with-EasyMail|Connect an EasyWebEditNet website with EasyMail]
</pre>
