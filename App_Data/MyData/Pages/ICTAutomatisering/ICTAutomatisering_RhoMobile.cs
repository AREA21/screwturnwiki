Motorola RhoMobile
procm|2014/05/07 11:08:12|(((mobile,mobile apps)))(((Motorola RhoMobile)))
##PAGE##
{TOC}
...
** [docs.rhomobile.com/en/4.0.0/rhoconnect/metadata|Building Dynamic Views with Metadata]
...
* [http://www.youtube.com/watch?v=Nh6z4xw7gmY|How to deploy new apps & use previously-deployed apps in '''RhoGallery.'''])))
</PRE>{TOP}
...
** read the configuration values using eg.: var softwareVersion = "<%= Rho::RhoConfig.ScanClientVersion %>"; 

* SDK Android Manager not opening
